...
//        gp.currentMap = 3;
    ...
    public void getImage()
    {
            ...
            up3 = setup("/player/boy_up_1",gp.tileSize,gp.tileSize);
            up4 = setup("/player/boy_up_2",gp.tileSize,gp.tileSize);
            down1 = setup("/player/boy_down_1",gp.tileSize,gp.tileSize);
            down2 = setup("/player/boy_down_2",gp.tileSize,gp.tileSize);
            down3 = setup("/player/boy_down_1",gp.tileSize,gp.tileSize);
            down4 = setup("/player/boy_down_2",gp.tileSize,gp.tileSize);
            left1 = setup("/player/boy_left_1",gp.tileSize,gp.tileSize);
            left2 = setup("/player/boy_left_2",gp.tileSize,gp.tileSize);
            left3 = setup("/player/boy_left_1",gp.tileSize,gp.tileSize);
            left4 = setup("/player/boy_left_2",gp.tileSize,gp.tileSize);
            right1 = setup("/player/boy_right_1",gp.tileSize,gp.tileSize);
            right2 = setup("/player/boy_right_2",gp.tileSize,gp.tileSize);
            right3 = setup("/player/boy_right_1",gp.tileSize,gp.tileSize);
            right4 = setup("/player/boy_right_2",gp.tileSize,gp.tileSize);
    }
