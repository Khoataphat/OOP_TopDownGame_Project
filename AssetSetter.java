...
*/
        ...
        for(int j=0; j<=100; j++) {
            if(j==100) {
                int k = 0;
                gp.obj[mapNum][k] = new OBJ_LandFills1(gp);
                gp.obj[mapNum][k].worldX = gp.tileSize * 32;
                gp.obj[mapNum][k].worldY = (int) (gp.tileSize * 8);
                k++;
                gp.obj[mapNum][k] = new OBJ_LandFills1(gp);
                gp.obj[mapNum][k].worldX = gp.tileSize * 32;
                gp.obj[mapNum][k].worldY = (int) (gp.tileSize * 9);
                k++;
                gp.obj[mapNum][k] = new OBJ_LandFills1(gp);
                gp.obj[mapNum][k].worldX = gp.tileSize * 32;
                gp.obj[mapNum][k].worldY = (int) (gp.tileSize * 10);
                k++;
                gp.obj[mapNum][k] = new OBJ_LandFills1(gp);
                gp.obj[mapNum][k].worldX = gp.tileSize * 17;
                gp.obj[mapNum][k].worldY = (int) (gp.tileSize * 8);
                k++;
                gp.obj[mapNum][k] = new OBJ_LandFills1(gp);
                gp.obj[mapNum][k].worldX = gp.tileSize * 17;
