...
public class NPC_Merchant extends Entity{
    ...
    public void getImage()
    {
        ...
        up4 = setup("/npc/merchant_down_1",gp.tileSize,gp.tileSize);
        ...
        down4 = setup("/npc/merchant_down_1",gp.tileSize,gp.tileSize);
        ...
        left4 = setup("/npc/merchant_down_1",gp.tileSize,gp.tileSize);
        ...
        right4 = setup("/npc/merchant_down_1",gp.tileSize,gp.tileSize);    }
