...
public class EventHandler{
    ...
    public void checkEvent()
    {
        ...
        if(canTouchEvent == true)
        {
            ...
            if(hit(0,42,44, "any") == true) {speak(gp.npc[1][0]);} //merchant
            ...
            else if(hit(0,47,88, "any") == true) {skeletonLord();} //BOSS
            else if(hit(0,47,89, "any") == true) {skeletonLord();} //BOSS
            else if(hit(0,47,90, "any") == true) {skeletonLord();} //BOSS
        }
